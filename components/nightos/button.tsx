...
const variants: Record<Variant, string> = {
  ...
  primary:
    "bg-wine-deep text-pearl-light-light hover:bg-wine-deep/95 active:bg-wine-deep shadow-warm",
  ...
  ruri: "bg-wine-deep text-pearl-light-light hover:bg-wine-deep/95 shadow-warm",

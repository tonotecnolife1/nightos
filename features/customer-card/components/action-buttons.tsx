  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2 h-12 rounded-btn bg-wine-deep text-pearl-light-light shadow-luxe active:scale-[0.98] transition-transform"
      >
